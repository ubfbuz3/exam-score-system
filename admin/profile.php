        ...
        <div class="row">
            ...
            <div class="col-md-2 sidebar">
                ...
                <div class="d-flex flex-column">
                    <a href="dashboard.php"><i class="fa fa-tachometer mr-2"></i>仪表盘</a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="avatar-container">
                                    <?php if (!empty($user['avatar'])): ?>
                                        <img src="../assets/images/avatars/<?php echo $user['avatar']; ?>" alt="管理员头像" class="avatar">
                                    <?php else: ?>
                                ...
                                <form>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="role" value="管理员" disabled>
                                    </div>
                                    <div class="mb-3">
                                        <label for="joined_date" class="form-label">注册日期</label>
                                        <input type="text" class="form-control" id="joined_date" value="<?php echo $user['created_at']; ?>" disabled>
                                    </div>
                                </form>
